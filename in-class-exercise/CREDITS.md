...
* <div class="attribution-block">Clip from Joseph R. Biden Jr.'s address at the presidential inauguration, January 20, 2020. Fair Use. Clip extracted using Audacity and <a href="https://github.com/mattingalls/Soundflower">Soundflower</a> (by Matt Ingalls) from a [video recording via the Washington Post](https://www.washingtonpost.com/politics/interactive/2021/01/20/biden-inauguration-speech/). </div>
